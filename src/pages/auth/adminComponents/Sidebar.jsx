      ...
      <aside id="sidebar-multi-level-sidebar" className="fixed pt-[5rem] top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <ul className="space-y-2 font-medium">
              <li onClick={() => onNavItemClick("dashboard")}>
              ...
              {/* <li>
                  <button type="button" className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example" onClick={toggleDropdown}>
                ...
                <div className="relative">
                  {isOpen && (
                    <ul
                      id="dropdown-example"
                      className="py-2 block space-y-2 relative top-full left-0 w-full   dark:bg-gray-800 dark:border-gray-600"
                    >
                      <li >
              ...
              {/* <li onClick={() => onNavItemClick("orderboard")}>
                  <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span className="flex-1 ms-3 whitespace-nowrap">Order Mangament</span>
                  </a>
              </li> */}

              <li onClick={() => onNavItemClick("inbox")}>
                  <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              ...
              {/* see user, only for super admin */}
              {/* <li onClick={() => onNavItemClick("users")}>
                  <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              ...
              <li onClick={() => onNavItemClick("products")}>
                  <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
